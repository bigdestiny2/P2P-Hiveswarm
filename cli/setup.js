...
const PROFILES = {
  ...
  standard: {
    ...
    services: ['identity', 'schema', 'sla', 'storage', 'compute', 'arbitration']
  },
  heavy: {
    ...
    services: ['identity', 'schema', 'sla', 'storage', 'compute', 'arbitration', 'ai', 'zk']
  },
  custom: {
...
const ALL_SERVICES = [
  ...
  { name: 'compute   — Serverless JS execution (vm sandbox)', value: 'compute' },
...
export async function runSetup () {
  ...
  console.log()
  const profileServices = config._selectedServices || ['identity', 'schema', 'sla', 'storage', 'compute', 'arbitration']
