...
echo ""
echo "Quick start:"
echo "  npx p2p-hiverelay start                  # Run a relay node"
echo "  npx p2p-hiverelay start --region NA      # Run in North America region"
echo "  npx p2p-hiverelay seed <pear-key>        # Seed a Pear app"
echo ""
echo "Development:"
