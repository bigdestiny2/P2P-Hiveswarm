 ...
 *   → Storage is dramatically cheaper (P2P, no cloud overhead)
 */
...
export class PricingEngine extends EventEmitter {
   ...
   * @param {number} [meta.durationMs] - Reserved for future duration-based pricing
  ...
  calculate (route, meta = {}) {
    ...
    // Duration-based pricing (reserved for future use)
